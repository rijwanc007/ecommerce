...
define('BOOKING_STATUS',[
    ...
    '2' => '<span class="label label-info label-pill label-inline" style="min-width:70px !important;">Reject</span>',
    '3' => '<span class="label label-warning label-pill label-inline" style="min-width:70px !important;">Approve</span>',
]);
define('ROUND_TRIP',[
    '1' => '<span class="label label-danger label-pill label-inline" style="min-width:70px !important;">No</span>',
    '2' => '<span class="label label-info label-pill label-inline" style="min-width:70px !important;">Yes</span>',
]);
define('ROUND_TRIP_VALUE',[
    '1' => 'No',
    '2' => 'Yes',
]);
define('BOOKING_STATUS_VALUE',[
    '1' => 'Pending',
    '2' => 'Reject',
    '3' => 'Approve',
]);

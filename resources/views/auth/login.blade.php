	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="container-fluid m-0 p-0">
			<div class="row m-0 p-0">
				<div class="col-md-8 d-none d-lg-block d-xl-block" style="background-image: url({{ asset('images/photo-1501159599894-155982264a55.avif') }});background-position: center;
				...
				<div class="col-md-4 col-sm-12 bg-white d-flex justify-content-center align-items-center shadow" style="min-height: 100vh;">
					<div class="card w-100" style="border: 0;">
						...
						<a href="{{ url('/') }}"><img src="{{ asset('storage/'.LOGO_PATH.config('settings.logo'))}}"  alt="Logo" style="max-width: 150px;" /></a>
						@else

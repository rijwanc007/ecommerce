        ...
        <div class="topbar">
            <div class="dropdown">
                <div  class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                    <form>
                        ...
                        <div class="scroll pr-7 mr-n7 ps ps--active-y" id="material-stock-alert" data-scroll="true" data-height="250" data-mobile-height="200"></div>
                    </form>
                </div>
            </div>
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span class="symbol symbol-35 symbol-light-success"><img class="header-profile-user" src="images/profile.svg" alt="Header Avatar"></span>
                </div>
            </div>
        </div>
    </div>
